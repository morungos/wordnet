...
get = function(location, callback) {
  ...
  return this.open(function(err, fd, done) {
    return WordNetFile.appendLineChar(fd, location, 0, buff, function(line) {
      ...
      synonyms = [];
      for (i = _i = 0, _ref = wCnt - 1; 0 <= _ref ? _i <= _ref : _i >= _ref; i = 0 <= _ref ? ++_i : --_i) {
        synonyms.push(tokens[4 + i * 2]);
      }
      ptrOffset = (wCnt - 1) * 2 + 6;
      for (i = _j = 0, _ref1 = parseInt(tokens[ptrOffset], 10) - 1; 0 <= _ref1 ? _j <= _ref1 : _j >= _ref1; i = 0 <= _ref1 ? ++_j : --_j) {
        ptrs.push({
