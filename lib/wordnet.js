...
WordNet = (function() {
  ...
  WordNet.prototype._forms = function(string) {
    var colloc, exclusion, forms, i, index, lword, pos, rtn, token, word, wordnet, _i, _j, _len, _len1, _ref, _ref1;
    wordnet = this;
    _ref = string.split('#'), word = _ref[0], pos = _ref[1];
    lword = word.toLowerCase();
    exclusion = (_ref1 = wordnet.exclusions[pos]) != null ? _ref1[lword] : void 0;
    if (exclusion) {
