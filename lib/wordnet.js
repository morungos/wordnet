var DataFile, IndexFile, WordNet, async, fs, path, tokenDetach, unique;
...
WordNet = (function() {
  ...
  WordNet.prototype._forms = function(word, pos) {
    var colloc, exclusion, forms, i, index, lword, rtn, token, wordnet, _i, _j, _len, _len1, _ref;
    wordnet = this;
    lword = word.toLowerCase();
    exclusion = (_ref = wordnet.exclusions[pos]) != null ? _ref[lword] : void 0;
    if (exclusion) {
  ...
  WordNet.prototype.forms = function(string) {
  ...
  WordNet.prototype.validForms = function(string) {
    var pos, possibleForms, sense, word, _ref;
    _ref = string.split('#'), word = _ref[0], pos = _ref[1], sense = _ref[2];
    if (!pos) {
      ...
      return possibleForms = forms(word + "#" + pos);
    }
  };
