var DataFile, IndexFile, WordNet, async, fs, path;
...
WordNet = (function() {
  var exclusions, forms, tokenDetach, unique, _forms, _validForms;
  ...
  _forms = function(word, pos) {
    var colloc, exclusion, forms, i, index, lword, rtn, token, wordnet, _i, _j, _len, _len1, _ref, _ref1;
    wordnet = this;
    lword = word.toLowerCase();
    exclusion = (_ref = wordnet.exclusions) != null ? (_ref1 = _ref[pos]) != null ? _ref1[lword] : void 0 : void 0;
    if (exclusion) {
      return [word].concat(exclusion);
    }
  ...
  _validForms = function(string, callback) {
    var filterFn, pos, possibleForms, sense, word, wordnet, _ref;
    wordnet = this;
    _ref = string.split('#'), word = _ref[0], pos = _ref[1], sense = _ref[2];
    if (!pos) {
      return ['n', 'v', 'a', 'r'].map(function(pos) {
        return this.validForms(string + "#" + pos);
  ...
  WordNet.prototype.validForms = function(string, callback) {
    ...
    if (wordnet.exceptions) {
      ...
      return wordnet.loadExclusions(function() {
        return _validForms(string, callback);
      });
    }
  };
