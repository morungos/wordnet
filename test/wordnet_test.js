...
describe('wordnet', function() {
  ...
  describe('get', function() {
    ...
    it('should fail with an error in a two argument callback', done => wordnet.get(3827108, 'n', function(err, results) {
  ...
  describe('getAsync', function() {
    ...
    it('should fail with an error', done => wordnet
      .getAsync(3827108, 'n')
  ...
  describe('lookup', function() {
    ...
    it('should succeed for alte#r', done => wordnet.lookup('alte#r', function(results) {
      should.exist(results);
      results.should.be.an.instanceOf(Array);
  ...
  describe('lookupAsync', function() {
    ...
    it('should succeed for words with odd glosses, e.g., in#r', done => wordnet.lookupAsync('in#r')
      .should.eventually.exist
      .should.eventually.be.an.instanceOf(Array)
  ...
  describe('querySense', function() {
    ...
    it('should succeed for ghostly#a', done => wordnet.querySense('ghostly#a', function(results) {
      should.exist(results);
      results.should.be.an.instanceOf(Array);
      results.should.have.length(1);
  ...
  describe('querySenseAsync', function() {
    ...
    it('should succeed for ghostly#a', done => wordnet.querySenseAsync('ghostly#a')
      .should.eventually.exist
      .should.eventually.be.an.instanceOf(Array)
      .should.eventually.have.length(1)
  ...
  describe('validForms', function() {
    ...
    it('should succeed for a set of queries pushed asynchronously', function(done) {
      const query = (item, callback) => wordnet.validForms(item, results => callback(null, results));

      async.map(['be#v', 'are#v'], query, function(err, results) {
        should.exist(results);
  ...
  describe('validFormsAsync', function() {
    ...
    it('should succeed for farther#r', done => wordnet.validFormsAsync('farther#r')
      .should.eventually.exist
